...
var bullet,ball,boomI
var score
var bgSound,bgPlaySound
function preload(){
  ...
  bgSound = loadSound("sound/bgs.mp3")
  bgPlaySound =loadSound("sound/kp.mp3")
}
...
// background(bgInt);
  ...
  text("press 1,2,3,4,5,6,7,8,9,0 to change the guns",250,500)
...
function playingArea(){
   ...
   player2.collide(g3)
    ...
    if(player1.isTouching(bomb)){
     player1.x =displayWidth/7
     player1.y =displayHeight/1.5
      ball.createSprite(bomb.x,bomb.y,10,10)
      ball.addImage(boomI)
